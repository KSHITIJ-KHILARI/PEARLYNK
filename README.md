...
The `website/` directory contains a premium landing page for the extension. It can be deployed to GitHub Pages or any static hosting.

> **Note:** After pushing to GitHub, update the Install and View Repository button URLs in `website/index.html` to point to your actual repository. Search for `YOUR_USERNAME` and replace with your GitHub username.
